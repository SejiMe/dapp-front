...
const WeeklyChartPerBarangay = ({ data }: { data: Probability[] }) => {
  ...
  const monthLabelPlugin = {
    ...
    afterDatasetsDraw(chart: any) {
      ...
      // Get theme colors
      const accentColor = getThemeColor("--a") || "#ff6b9d";
      const borderColor = getThemeColor("--bc") || "#d1d5db";
    ...
    <div className="card bg-base-100 shadow-xl">
      <div className="card-body">
        ...
        <ChartComponent
          ...
          options={options}
          plugins={[monthLabelPlugin]} // ← CHANGED: Pass as separate prop!
          height={450}
        />
      </div>
    </div>
...
export default WeeklyChartPerBarangay;

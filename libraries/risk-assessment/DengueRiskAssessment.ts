...
const RISK_SUGGESTIONS: Record<RiskLevel, DengueSuggestions> = {
  [RiskLevel.LOW]: {
    general: [
      "Continue routine monitoring of dengue symptoms",
  ...
  [RiskLevel.MODERATE]: {
    general: [
      "Increase vigilance for dengue symptoms",
      "Strengthen community monitoring efforts",
    ],
    community: [
  ...
  [RiskLevel.HIGH]: {
    general: [
      ...
      "Issue community health advisories",
    ],
    community: [
  ...
  [RiskLevel.CRITICAL]: {
    general: [
      ...
      "Implement mass awareness campaigns",
    ],
    community: [
